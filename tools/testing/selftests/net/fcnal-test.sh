...
ipv4_tcp_authopt_vrf()
{
	...
	sleep 1
	run_cmd_nsb nettest -r ${NSA_IP} -A ${MD5_PW}
	log_test $? 0 "AO: VRF: Single address config in default VRF and VRF, conn in VRF"
	...
	log_test $? 0 "AO: VRF: Single address config in default VRF and VRF, conn in default VRF"
	...
	log_test $? 2 "AO: VRF: Single address config in default VRF and VRF, conn in default VRF with VRF pw"
	...
	sleep 1
	run_cmd_nsb nettest -r ${NSA_IP} -A ${MD5_WRONG_PW}
	log_test $? 2 "AO: VRF: Single address config in default VRF and VRF, conn in VRF with default VRF pw"
}
